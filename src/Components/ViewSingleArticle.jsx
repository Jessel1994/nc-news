...
function ViewSingleArticle({ user }) {
  ...
  const articleViewer = async () => {
    ...
    const {
      data: { articles },
    } = await getArticleByArticleId(routeParams.article_id);
          ...
          <article key={viewArticle.article_id}>
            <li className="article">
              ...
              <img
                ...
                src={viewArticle.article_img_url}
                alt="article picture"
              />
...
function CommentSection({
  ...
  const commentViewer = async () => {
    ...
    const {
      data: { comments },
    } = await getCommentsByArticleId(routeParams.article_id);
